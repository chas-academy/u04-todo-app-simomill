<div class="item">
    ...
    <form style="display: inline-block" action="tasks/delete.php" method="post">
    ...
    <a class="btn small" href="tasks/update.php?id=<?php echo $task['id'] ?>">
        <i class="fas fa-pencil-alt"></i>
    </a>
    
    <!-- <a class="btn small" href="update.php?id=<?php echo $task['id'] ?>" class="btn btn-sm btn-outline-primary">Edit</a> -->

    <form action="tasks/complete.php" method="post" id="completed_form">
        <input type="hidden" name="id" value="<?php echo $task['id'] ?>">
